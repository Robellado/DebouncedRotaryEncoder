...
int lastPosition;
int encPinA = 2; //interrupt pin        
int encPinB = 3; //interrupt pin
...
void setup() {
	...
	attachInterrupt(digitalPinToInterrupt(encPinA), ISREnc, CHANGE);
	attachInterrupt(digitalPinToInterrupt(encPinB), ISREnc, CHANGE);
}
